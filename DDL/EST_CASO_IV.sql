...
alter table planos_treinamento change column descricao contexto varchar(200);
alter table aulas add equipamentos varchar(10);
alter table pagamentos add moeda_pagamento varchar(10);
